    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('form_type', models.CharField(choices=[('físico', 'Físico'), ('digital', 'Digital')], default='digital', max_length=50)),
                ...
                ('dispatch', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='proposal_dispatches', to='financial.dispatch')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_type', models.CharField(blank=True, choices=[('RG', 'RG'), ('Contrato', 'Contrato'), ('Contracheque', 'Contracheque'), ('Outro', 'Outro')], max_length=100, null=True)),
                ('uploaded_at', models.DateTimeField(auto_now_add=True)),
                ('proposal', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='files', to='proposal.proposal')),
                ('uploaded_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='files', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
